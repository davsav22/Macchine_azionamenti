...
def plot_training_curves(train_hist, test_hist):
    ...
    ax.set_xlabel("Epoch")
    ax.set_ylabel("Estimated total evidence")      # <- rinominato
    ax.set_ylim(0, 350)                            # <- fissato limiti
    ax.legend()
    ...
    ax.set_xlabel("Epoch")
    ax.set_ylabel("Estimated total evidence")      # <- idem
    ax.set_ylim(0, 350)                            # <- idem
    ax.legend()
